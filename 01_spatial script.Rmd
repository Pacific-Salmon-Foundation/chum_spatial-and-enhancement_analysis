...
```{r releases for area 25, fig.align="center", fig.height=6, fig.width=8, fig.cap="Total hatchery chum salmon releases in Area 25",echo=FALSE,warning=FALSE,message=FALSE}
