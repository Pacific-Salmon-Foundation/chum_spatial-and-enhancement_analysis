...
rpsdat <- read_csv("data/area 25 chum rps.csv")
...
AICtable<-AIC(lrps_dist, lrps_rels, lrps_dist_rels)%>%arrange(AIC) #rps_dist model selected by AIC and arranged top to bottom
