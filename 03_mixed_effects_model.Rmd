...
EP_ESC_DIST <- effect_plot(fdist, pred = distancefromconuma, interval = TRUE, plot.points = TRUE, jitter = 0,
...
saveRDS(EP_ESC_DIST, "RDS/EP_ESC_COR.rds")
saveRDS(EP_ESC_TOTREL, "RDS/EP_ESC_COR.rds")
