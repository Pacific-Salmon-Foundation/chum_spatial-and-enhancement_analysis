...
```{r}
#total return plot
ggplot(rps,aes(x=Year,y=TR))+
  geom_line()+geom_point()+
  facet_wrap(~SYS_NM,ncol=3,scale="free_y")

#rps plots
ggplot(rps,aes(x=Year,y=rps))+
  geom_line()+geom_point()+
...
```{r total releases for area 8 terminal not including mcloughlin bay, include = FALSE}

# HOLDING THIS SCRIPT IN HERE WHILE I WRAP UP KNITS FOR A25 IN SPATIAL SCRIPT.
# NOT SURE IF YOU MEANT FOR THIS TO BE IN THERE YET OR NOT
