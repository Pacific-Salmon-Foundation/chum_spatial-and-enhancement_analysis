...
```{r, Log recruits per spawner by system, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Douglas-Gardner chum: log recruits per spawner by system."}
...
```{r, Boxplot of log RPS by system, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Douglas-Gardner chum: boxplot of log recruits per spawner by system."}
...
saveRDS(dg, "RDS/a06_logrps_dg.rds")
