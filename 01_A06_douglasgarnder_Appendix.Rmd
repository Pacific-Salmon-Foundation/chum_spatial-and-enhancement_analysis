...
```{r, Correlation plots by metric, echo = FALSE, message = FALSE, error = FALSE, fig.align = "center", fig.height = 7.5, fig.width = 8.5, fig.cap = "Cross correlation plots to compare metrics."}
par(oma=c(0,0,0,0))
par(mfrow=c(3,2))
