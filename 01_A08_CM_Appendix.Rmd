...
```{r, Correlation analyses, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.height = 9.5, fig.width = 8.5, fig.cap = "Cross correlation plots to compare metrics."}
...
```{r, Prep data for dendrogram visualization, echo = FALSE, message = FALSE, warning = FALSE, include = FALSE}


clust.dist.cor.z[["labels"]] <- str_to_sentence(word(clust.dist.cor.z[["labels"]]))
dendz <- as.dendrogram(clust.dist.cor.z)
plot(dendz, horiz = TRUE)
