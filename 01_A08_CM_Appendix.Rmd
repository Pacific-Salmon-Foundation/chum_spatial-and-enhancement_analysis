...
rpscands <- as.data.frame(rbind(candidates[1:3,], candidates[7:9,]))
esccands <- as.data.frame(rbind(candidates[4:6,], candidates[10:12,]))

rpsaic <- AIC(a, b, d, wa, wb, wd)
escaic <- AIC(ea, eb, ed, wea, web, wed)
