...
effect_plot(wx, pred = releases_bel, interval = TRUE, plot.points = TRUE, x.label = "Releases from Bella Coola", y.label = "Log escapement")
...
effect_plot(wx, pred = releases_mcl, interval = TRUE, plot.points = TRUE, x.label = "Releases from McLoughlin", y.label = "Log escapement")
