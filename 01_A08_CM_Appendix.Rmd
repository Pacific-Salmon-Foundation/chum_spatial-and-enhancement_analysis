...
model.z <- nls(zscore ~ a * distance ^ b, 
               data = dist_corr,
...
a<- ggplot(zplot, aes(distance/1000, zscore)) +
  ...
  geom_label_repel(aes(label = plotlabels),
                   data = subset(zplot, zscore < 0),  # These lines label negative outliers
                   size = 2.5) +
...
b<- ggplot(logrpsplot, aes(distance/1000, logrps)) +
  ...
  #geom_label_repel(aes(label = plotlabels),
   #                data = subset(logrpsplot, logrps < 0.35),  # These lines label negative outliers
    #               size = 2.5) +
