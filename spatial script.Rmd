...
escdata<-fread("all nuseds with enhancement rankings.csv")%>%
  select(-V1)
...
streaminlet[21,4] <- "esperanza" # PLACEHOLDER FOR RANSOM RIVER INLET
streaminlet[21,5] <- "esperanza" # PLACEHOLDER FOR RANSOM RIVER SUBINLET
...
nameslookup <- as.data.frame(c("Tlupana", "Canton", "Conuma", "Leiner", "Deserted", "Sucwoa", 
                 "Gold", "Mooyah", "Ransom", "Burman", "Kleeptee", "Espinosa",
...
nameslookup$erank <- c("red", "red", "red", "black", "yellow", "red",
...
```{r dendrograms for all metrics, echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center", fig.height = 10.5, fig.width = 9.5, fig.cap = "Dendrograms by metric. Red labels are from Esperanza inlet, blue are from Nootka inlet, and green are from Tahsis inlet. Rivers and creek denoted with black circles have no enhancement rank, yellow have low, orange have medium, and red have high enhancement ranks."}
# Dendrograms to knit
par(oma=c(2,2,2,2))
par(mfrow=c(2,2))
...
```{r, Corr plots for log escapement, pre- and post-1980, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Cross correlation plots to compare log escapements pre- and post-enhancement."}
...
```{r, Corr plots for standardized escapements, pre- and post-1980, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Cross correlation plots to compare standardized escapements pre- and post-enhancement."}
...
```{r, Corr plots for moving average, pre- and post-1980, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Cross correlation plots to compare moving average pre- and post-enhancement."}
...
```{r, z-score tanglegram, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Tanglegram comparing z-scores pre- and post-enhancement (1980)"}
# Dendrogram, factored by inlet, by z-score
...
```{r, Log escapements tanglegram, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Tanglegram comparing log escapements pre- and post-enhancement (1980)"}
...
```{r, Standardized escapements tanglegram, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Tanglegram comparing log escapements pre- and post-enhancement (1980)"}
...
```{r, Moving averages tanglegram, fig.align = "center", fig.height = 8, fig.width = 6, fig.cap = "Tanglegram comparing moving averages pre- and post-enhancement (1980)"}
