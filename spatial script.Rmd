...
```{r correlation plots, echo=FALSE,warning=FALSE,message=FALSE,fig.align="center",fig.height=8.5,fig.width=7.5,fig.cap="Cross correlation plots to compare metrics."}
...
```{r dendrograms for all metrics,echo=FALSE,warning=FALSE,message=FALSE}
# Dendrograms to knit
par(mfrow=c(1,1))
