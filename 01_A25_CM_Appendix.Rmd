...
ggplot(zplot, aes(distance/1000, zscore)) +
  geom_point() +
...
ggplot(logrpsplot, aes(distance/1000, logrps)) +
  geom_point() +
...
```{r pairwise z-scores pre- and post-1980, echo = FALSE, message = FALSE, warning = FALSE}
...
```{r pairwise log RPS pre- and post-1980, echo = FALSE, message = FALSE, warning = FALSE}
