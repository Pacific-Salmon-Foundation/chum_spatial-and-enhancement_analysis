...
```{r, Comparison of Z-score pre- and post-1980, message = FALSE, warning = FALSE, error = FALSE, echo = FALSE,fig.align = "center", fig.height = 8, fig.width = 7, fig.cap = "Boxplot comparing Z-score pre- and post-1980."}

saveRDS(dgz, "RDS/a25_z_dg.rds")

ggplot(dgz,aes(x=period,y=cc,fill=period))+
  geom_boxplot() +
  xlab("Period") +
...
```{r, Comparison of log RPS pre- and post-1980, message = FALSE, error = FALSE, warning = FALSE, echo = FALSE,fig.align = "center", fig.height = 8, fig.width = 7, fig.cap = "Boxplot comparing log RPS pre- and post-1980."}

saveRDS(dglog, "RDS/a25_logrps_dg.rds")

ggplot(dglog,aes(x=period,y=cc,fill=period))+
  geom_boxplot() +
  xlab("Period") +
  ylab("Correlation coefficient")
