...
```{r, Log recruits per spawner by system, echo = FALSE, message = FALSE, warning = FALSE, fig.align = "center", fig.height = 8, fig.width = 8, fig.cap = "Douglas-Gardner chum: log recruits per spawner by system."}
