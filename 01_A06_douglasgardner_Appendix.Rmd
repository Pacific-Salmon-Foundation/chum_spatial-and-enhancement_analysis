...
```{r means by enhancement rank, echo=FALSE,warning=FALSE,message=FALSE,fig.align="center",fig.height=4,fig.width=6,fig.cap="Douglas-Gardner chum: Mean Z-score for analsyis streams by enhancement rank."}
